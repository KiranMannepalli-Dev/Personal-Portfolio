    ...
    <section id="about" className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 mt-10 sm:mt-14 md:mt-16">
          <AnimatedText 
            text="Computer Science graduate with full-stack development experience and hands-on prompt engineering work using the OpenAI GPT API. I've delivered 10+ web applications and multiple full-stack projects, combining strong software engineering fundamentals with practical experience in building AI-driven solutions."
